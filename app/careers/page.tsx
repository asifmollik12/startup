...
const defaultSections = [
  ...
  { title: "Social Media Manager", content: "Grow our presence across Facebook, LinkedIn, and Instagram. Create content that resonates with Bangladesh's entrepreneurial community. Part-time · Remote" },
  { title: "Research Analyst", content: "Compile data for our annual rankings, startup database, and industry reports. Strong analytical skills and knowledge of BD business landscape required. Full-time · Dhaka" },
];
...
export default async function CareersPage() {
  ...
  const heroTitle = page?.hero_title || "Build the Future of BD Startup Media";
  const heroSubtitle = page?.hero_subtitle || "We're a small, ambitious team on a mission to tell the stories of Bangladesh's entrepreneurs. If you care about great journalism and great products — we want to hear from you.";
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-brand-dark text-white py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="container-wide relative">
          ...
          <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">{heroSubtitle}</p>
        </div>
      </div>
      ...
      <div className="bg-brand-gray border-t border-brand-border py-16">
        <div className="container-wide text-center max-w-xl mx-auto">
          ...
          <p className="text-gray-500 mb-6">Send us your CV and tell us how you&apos;d contribute.</p>
          <a href="mailto:careers@start-upnews.com" className="btn-primary">careers@start-upnews.com <ArrowRight size={14} /></a>
        </div>
      </div>
    </div>
  );
